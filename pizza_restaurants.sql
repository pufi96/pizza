...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2021 at 01:01 AM
...
CREATE TABLE `about` (
  ...
  `descriptionAbout` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `about` (`idAbout`, `nameAbout`, `descriptionAbout`, `srcImgAbout`, `altImgAbout`) VALUES
...
CREATE TABLE `menu` (
  ...
  `descriptionMenu` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `menu` (`idMenu`, `nameMenu`, `descriptionMenu`, `srcImgMenu`, `altImgMenu`, `priceMenu`, `visibleMenu`) VALUES
...
INSERT INTO `slider` (`idSlider`, `subHeading`, `mainHeading`, `postHeading`, `srcImgSlider`, `altImgSlider`) VALUES
...
--
ALTER TABLE `menu`
  MODIFY `idMenu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `rating`
  MODIFY `idRating` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
